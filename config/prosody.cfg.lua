...
component_interface = "prosody.components"

------ Module http -----

--http_ports = { 5280 }
--http_interfaces = { "prosody.traefik" }
...
-- To allow Prosody to offer secure authentication mechanisms to clients, the-- default provider stores passwords in plaintext. If you do not trust your
...
Component "xmpp.${DOMAIN}" "http"
        modules_enabled = { "bosh", "http_upload" }

----- Mode mam -----

max_archive_query_results = 50;

archive_expires_after = "1w" -- one day
